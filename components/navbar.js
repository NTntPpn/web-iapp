    ...
    return (
        <div className='sticky top-0 z-[999]'>
            ...
            <nav className="w-full h-auto shadow font-suk ">
                <div className={`md:h-[48px] ${navbar ? "bg-[#F2F3FD] h-screen" : "bg-[#4E65FF]"}  justify-between mx-auto md:items-center md:flex md:px-[144px] shadow`}>
                    ...
                    <div>
                        <div className={`h-auto md:flex-1 text-left md:text-center  md:block md:pb-0 md:mt-0 ${navbar ? "block" : "hidden"}`}>
                            ...
                            {mainmanu ? 
                                        (
                                            <div className="md:flex flex-wrap w-screen h-auto min-h-min md:bg-[#F5F5F5] shadow absolute md:top-[48px] md:left-0 text-center md:pl-[9.72%] md:pr-[13.33%] font-extralight items-center md:gap-[16px] justify-center text-[#595959] pt-1.5 md:pt-0">
