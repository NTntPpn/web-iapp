...
function Contact() {
    return (   
        <div className='pt-[80px] bg-[#FAFAFA]'>
            <div class="grid grid-cols-1 h-screen text-center items-center  bg-Fbox bg-cover bg-center font-suk" >
                <div className='w-[205px] h-[60px] text-[38px] tracking-tighter text-white mx-auto mt-[86px]'>
                    ติดต่อเราได้ที่
                </div>
                ...
                <div>
                    <h1 class="justify-items-center text-white text-lg md:text-xl font-bold mt-8">ส่งเมลหาเราได้ที่ sale@iapp.co.th</h1>
                </div>
