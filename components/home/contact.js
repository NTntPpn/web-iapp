...
function Contact() {
    return (   
        <div className='pt-[80px] bg-[#FAFAFA] h-auto md:h-[812px]'>
            <div className="h-full  bg-Fbox bg-cover bg-center font-suk pt-[86px] pb-[53px]">
                <div className='md:w-[468px] h-auto mx-auto'>
                    <div className='w-full text-[16px] md:text-[38px] text-center text-white font-medium'>
                        ติดต่อเราได้ที่
                    </div>

                    <div className='w-full h-full md:flex mt-[15px]'>
